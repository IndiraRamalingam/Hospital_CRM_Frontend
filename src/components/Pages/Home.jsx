...
import AdminSiginIn from '../SignIn/AdminSiginIn'
  ...
  <div className="row gx-lg-5">
    ...
    <div className="col-lg-4 mb-5 mt-5">
      <div className="d-flex align-items-start">
        <div className="flex-shrink-0 ms-5">
          <div className="p-3 badge-primary">
    ...
    <div className="col-lg-4 mb-5 mt-5">
      <div className="d-flex align-items-start">
        ...
        <div className="flex-grow-1 ms-3">
          <h4 className="fw-bold mb-2">DOCTOR</h4>
          <p className="text-muted fw-bold mb-2">
            Doctor Credentials:
          </p>
          <p className="text-muted mb-2">
            <b>Email: </b>doctor@gmail.com
          </p>
          <p className="text-muted mb-2">
            <b>Password: </b> 123
          </p>
         <Link to='/doctorsignin'>LOGIN</Link>
        </div>
      </div>
    </div>
    ...
    <div className="col-lg-4 mb-5 mt-5">
      <div className="d-flex align-items-start">
        ...
        <div className="flex-grow-1 ms-3">
          <h4 className="fw-bold mb-2">PATIENT</h4>
          <p className="text-muted fw-bold mb-2">
            Patient Credentials:
          </p>
          <p className="text-muted mb-2">
